...
def food_portrayal(agent):
    portrayal = {}
    portrayal["Shape"] = "icons/flower.png"
    portrayal["scale"] = 0.9
    portrayal["Layer"] = 1
    portrayal["Filled"] = "true"
...
def obstacle_portrayal(agent):
    portrayal = {}
    portrayal["Shape"] = "icons/house.png"
    portrayal["scale"] = 0.9
    portrayal["Layer"] = 0
    portrayal["Filled"] = "true"
...
chart_element = ChartModule([{"Label": "Bees", "Color": "#AA0000"}, {"Label": "HiveFood", "Color": "#000000"}, {"Label": "Scout bees", "Color": "#70a5f9"},
    {"Label": "Foraging bees", "Color": "#f4b042"}, {"Label": "Rester bees", "Color": "#17ef71"}], 500, 500)
